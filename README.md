# Nextcloud with OnlyOffice Community Edition on Docker

Preconfigured version of [ONLYOFFICE Document Server][2] connected to Nextcloud running in Docker containers.
